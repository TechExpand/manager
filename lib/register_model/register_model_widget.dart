...
class RegisterModelWidget extends StatefulWidget {
  const RegisterModelWidget({Key key}) : super(key: key);

  @override
  _RegisterModelWidgetState createState() => _RegisterModelWidgetState();
}

class _RegisterModelWidgetState extends State<RegisterModelWidget> {

...
class Gigs2Widget extends StatefulWidget {
  const Gigs2Widget({Key key}) : super(key: key);

  @override
  _Gigs2WidgetState createState() => _Gigs2WidgetState();
}

class _Gigs2WidgetState extends State<Gigs2Widget> {
  ...
  void initState() {
    ...
    musicstream = FirebaseApi.getMusicGigStream();
  }
                                      ...
                                      child: InkWell(
                                        onTap: () async {
                                          await Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                              builder: (context) => GigPageWidget(data:gig),
                                            ),
                                          );
                                        },
                                        child: Container(
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(
                                                                compareDate(DateTime.parse(gig.postTime)),
                                                                style: FlutterFlowTheme.of(
                                                                    context)
                                                                    .bodyText2
                                                                    .override(
